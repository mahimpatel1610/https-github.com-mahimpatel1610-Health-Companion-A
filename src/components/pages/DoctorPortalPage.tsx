...
export const DoctorPortalPage: React.FC<DoctorPortalPageProps> = ({
  ...
  const handleManualSync = async () => {
    ...
    try {
      ...
      setTimeout(() => setIsSyncingMessages(false), 500);
    }
  };
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200 dark:border-slate-800">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                  Direct questions sent by patients through the Contact Clinic and Doctor profiles. Reply directly to patients here. Synced in real-time across all laptops and devices.
                </p>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <RefreshCw className={`w-3.5 h-3.5 ${isSyncingMessages ? 'animate-spin text-teal-600' : ''}`} />
